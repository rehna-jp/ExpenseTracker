...
export const BudgetSummary = () => {
  ...
  return(
    <div className='w-2/4 bg-[#272626] flex flex-col justify-around p-4 rounded-xl mt-6'>
        ...
        <button onClick={() => setShowModal(true)} className='mt-5 bg-purple-500 hover:bg-purple-600 px-4 py-2 rounded-md text-white cursor-pointer'>Update Budget</button>
    </div>
  )
}
...
const BudgetComponent = () => {
  ...
  const {budget, setBudget} = useContext(ExpensesContext);
  ...
  return (
    <div className='flex flex-col items-center mt-8'>
      ...
      {activeTab === 'settings' && (
             ...
             <button type='submit' className='mt-5 bg-purple-500 hover:bg-purple-600 px-4 py-2 rounded-md text-white cursor-pointer'>Save</button>
             </form>
          </div>
      )}
